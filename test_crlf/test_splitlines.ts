// Test file for splitLinesForEditInput behavior
// This file demonstrates the line ending issues in OpenVibe on Linux/WSL

console.log('Testing splitLinesForEditInput function');
node -e "
